...
export default function Auctions() {
  return (
    <div className="flex flex-col lg:p-16 p-7 w-full mt-20">
        <div className="flex justify-between items-end">
            <div className="text-white flex flex-col gap-10">
                <p className=" text-base">Most Appreciated NFTs On Site For The Day</p>
                <h1 className="md:text-5xl text-3xl">Live Auction NFTs</h1>
            </div>
